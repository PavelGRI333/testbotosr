...
_USER_PROMPT = (
    "Распознай накладную и верни JSON по схеме. "
    "Первое изображение — страница 1 (основная): с неё бери все поля шапки (поставщик, ИНН, "
    "адрес доставки, номер, дата) и таблицу товаров. "
    "Второе изображение (если приложено) — страница 2: используй его ТОЛЬКО как продолжение "
    "таблицы товаров, если таблица не поместилась на странице 1. "
    "Поля шапки и адрес со страницы 2 не бери. "
